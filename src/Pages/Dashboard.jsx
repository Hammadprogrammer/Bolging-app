...
const Dashboard = () => {
  ...
  return (
    <>
      <Navbar />
      <NavbarBlow />
      <div className='flex items-center sm:items-start flex-col justify-start sm:pl-[100px] pl-0 bg-gray-300 min-h-screen'>
        <div className='flex items-center flex-col justify-center gap-5 max-h-96 bg-white w-[95%] sm:w-[80%] mt-20 rounded-lg shadow-lg'>
          <input
            type="text"
            id="blog-title-input"
            className="mt-8 block w-[80%] p-3 text-gray-800 border border-gray-200 rounded-md text-sm focus:ring-blue-400 focus:border-blue-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <textarea
            id="blog-content"
            rows={5}
            className="block p-3 w-[80%] text-sm text-gray-800 bg-gray-100 rounded-md border border-gray-200 focus:ring-blue-400 focus:border-blue-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div className='w-[80%] flex justify-center'>
            <button
              type="submit"
              disabled={isSubmitting}
              className={`flex items-center justify-center w-36 py-2 rounded-lg transition duration-300 ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-blue-600 text-white hover:bg-blue-700'
                }`}
            >
              {isSubmitting ? (
                <svg
              ...
              {isSubmitting && <span className="ml-2">Loading...</span>}
            </button>
          </div>
        </div>
        ...
        <div className='  bg-white w-[95%] sm:w-[80%] rounded-md border shadow-md'>
